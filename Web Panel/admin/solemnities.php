...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .card { background:
    label { display:block; margin:10px 0 4px; font-size:13px; color:
    input[type="text"], select { width:100%; border:1px solid
    select:not([multiple]) { appearance:none; -webkit-appearance:none; -moz-appearance:none; padding:10px 40px 10px 11px; background-color:
    select:not([multiple]):hover { border-color:
    ...
    .row-actions button.danger { display:inline-flex; align-items:center; justify-content:center; background:
    ...
    .badge { display:inline-flex; align-items:center; padding:3px 7px; border-radius:999px; background:rgba(148,163,184,.12); color:
